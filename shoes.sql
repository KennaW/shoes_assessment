...
COPY brands (brand_name, id) FROM stdin;
	1
	2
brand	3
new shoe	4
...
COPY brands_stores (store_id, brand_id, id) FROM stdin;
7	6	1
\.
...
SELECT pg_catalog.setval('brands_stores_id_seq', 1, true);
...
COPY stores (store_name, id) FROM stdin;
this store	7
\.
